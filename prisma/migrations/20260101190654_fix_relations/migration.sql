...
-- DropForeignKey
ALTER TABLE "groups" DROP CONSTRAINT "groups_groupUserId_fkey";

-- DropForeignKey
ALTER TABLE "sessions" DROP CONSTRAINT "sessions_user_id_fkey";

-- DropForeignKey
ALTER TABLE "users" DROP CONSTRAINT "users_groupUserId_fkey";

-- AlterTable
ALTER TABLE "GroupUser" ADD COLUMN     "groupId" TEXT,
